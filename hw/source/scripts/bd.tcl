...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#ENET Reset#GPIO#GPIO#GPIO#GPIO#UART 0#UART 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-344,-121",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1100 -y 390 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1100 -y 410 -defaultsOSRD
preplace portBus btn -pg 1 -lvl 0 -x 0 -y 300 -defaultsOSRD
preplace portBus led -pg 1 -lvl 4 -x 1100 -y 160 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 430 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 230 -y 190 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 930 -y 150 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 3 -x 930 -y 310 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 610 -y 140 -defaultsOSRD
preplace netloc axi_gpio_0_gpio_io_o 1 3 1 NJ 160
preplace netloc axi_gpio_1_ip2intc_irpt 1 0 4 30 330 NJ 330 760J 400 1070
preplace netloc btn_1 1 0 4 NJ 300 NJ 300 770J 420 1080
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 80 440 290 780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 90 430
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 460 280 790
preplace netloc processing_system7_0_DDR 1 1 3 NJ 390 NJ 390 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 770 150n
...
levelinfo -pg 1 0 230 610 930 1100
pagesize -pg 1 -db -bbox -sgen -110 0 1220 530
"
}
